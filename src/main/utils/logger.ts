...
const error = (filename: string, text: string): void => {
  log.error(`${filename}: ${text}`)
}

const warn = (filename: string, text: string): void => {
  log.warn(`${filename}: ${text}`)
}

const info = (filename: string, text: string): void => {
  log.info(`${filename}: ${text}`)
}

const debug = (filename: string, text: string): void => {
